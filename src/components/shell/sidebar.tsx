...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* Nav */}
      {/* data-tour anchors: the rail itself, then one per item keyed by href, so
          tour steps can point at any nav entry without touching this file again. */}
      <nav data-tour="sidebar" className="flex-1 overflow-y-auto no-scrollbar px-3 py-4 space-y-5">
