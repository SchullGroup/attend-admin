  ...
  return (
    <header className="sticky top-0 z-30 h-14 flex items-center border-b border-[hsl(var(--border))] bg-[hsl(var(--background)/0.95)] backdrop-blur px-6 gap-4">
      ...
      <div className="flex items-center gap-2 shrink-0">
        {currentUser?.logoUrl && (
          <div className="h-8 px-2 rounded-lg border border-[hsl(var(--border))] bg-white flex items-center justify-center overflow-hidden">
            <img src={currentUser.logoUrl} alt="Org logo" className="h-5 w-auto max-w-[80px] object-contain" />
          </div>
        )}
