...
export const MOCK_ORGANISERS: Organiser[] = [
...
export type AuditCategory = "auth" | "events" | "organisers" | "kyc" | "voting" | "documents" | "system";
...
export const MOCK_AUDIT_LOG: AuditLogEntry[] = [
  ...
  { id: "aud_003", timestamp: "2026-06-05T08:35:02Z", actor: "Stanley Jacob", actorEmail: "stanley.jacob@meristem.com", actorRole: "super_admin", action: "Registrar enrolled", category: "organisers", resource: "AIICO Insurance Plc", details: "Status changed: pending → active", ip: "197.210.54.12", severity: "info" },
  ...
  { id: "aud_019", timestamp: "2026-06-01T13:00:00Z", actor: "Stanley Jacob", actorEmail: "stanley.jacob@meristem.com", actorRole: "super_admin", action: "Registrar suspended", category: "organisers", resource: "Nigerian Breweries Plc", details: "Reason: Non-payment of platform fees", ip: "197.210.54.12", severity: "warning" },
  { id: "aud_020", timestamp: "2026-06-01T11:20:00Z", actor: "Stanley Jacob", actorEmail: "stanley.jacob@meristem.com", actorRole: "super_admin", action: "Registrar application rejected", category: "organisers", resource: "BUA Foods Plc", details: "Reason: Incomplete regulatory documentation", ip: "197.210.54.12", severity: "info" },
  ...
  { id: "aud_027", timestamp: "2026-05-26T16:00:00Z", actor: "Stanley Jacob", actorEmail: "stanley.jacob@meristem.com", actorRole: "super_admin", action: "Registrar enrolled", category: "organisers", resource: "FintechNGR Association", details: "Plan: Starter · Contact: admin@fintechngr.org", ip: "197.210.54.12", severity: "info" },
