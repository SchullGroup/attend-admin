          ...
          <table className="w-full min-w-[900px]">
            ...
            <tbody>
              {filtered.length === 0 ? (
                ...
                filtered.map((entry) => {
                  const sev = SEVERITY_CONFIG[entry.severity as AuditSeverity];
                  const cat = CATEGORY_COLORS[entry.category as AuditCategory];
                    ...
                    <React.Fragment key={entry.id}>
                      ...
                      >
                        ...
                        <td className="px-5 py-3">
                          ...
                          >
                            {CATEGORY_LABELS[entry.category as AuditCategory]}
                          </span>
                        </td>
