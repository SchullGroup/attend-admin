          ...
          <Card className="attend-card p-5">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="rounded-xl bg-[hsl(var(--muted)/0.5)] p-4">
                ...
                <p className="text-sm font-semibold text-[hsl(var(--foreground))]">{maskBVN(participant.bvn)}</p>
              </div>
              <div className="rounded-xl bg-[hsl(var(--muted)/0.5)] p-4">
                <p className="attend-section-title mb-2">CHN</p>
                <p className="text-sm font-semibold text-[hsl(var(--foreground))]">{maskCHN(participant.chn)}</p>
              </div>
              <div className="rounded-xl bg-[hsl(var(--muted)/0.5)] p-4">
                <p className="attend-section-title mb-2">NIN</p>
                <p className="text-sm font-semibold text-[hsl(var(--foreground))]">Not provided</p>
              </div>
            </div>
          </Card>
