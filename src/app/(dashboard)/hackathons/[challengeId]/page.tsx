  ...
  return (
    <div className="grid grid-cols-3 gap-5">
      ...
      <div className="col-span-2 flex flex-col gap-5">
        ...
        {/* Stat cards */}
        <div data-tour="challenge-stats" className="grid grid-cols-4 gap-4">
          {[
        ...
        <Card className="attend-card p-5">
          ...
          <div className="flex items-center justify-between">
            ...
            {!readOnly && (
              ...
              >
                <span data-tour="challenge-open-toggle" className="inline-flex items-center gap-1">
                  {c.applicationsOpen
...
function JudgesTab({ challengeId, readOnly = false }: { challengeId: string; readOnly?: boolean }) {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      {/* Application assignments — only shown once at least one judge is on the panel */}
      {judges.length > 0 && (
        <>
          <div className="border-t border-[hsl(var(--border))] mt-2" />
          <AssignmentsSection
            challengeId={challengeId}
            judges={judges}
...
export default function ChallengeDetailPage({
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      {/* Tab bar */}
      <div data-tour="challenge-tabs" className="flex items-center gap-1 bg-[hsl(var(--muted))] rounded-full p-1">
        {tabs.map((t) => (
          <button
            key={t}
            data-tour={`challenge-tab:${t}`}
            onClick={() => setTab(t)}
