      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-[hsl(var(--muted-foreground))] mt-1">
            {team.length} member{team.length !== 1 ? "s" : ""} · manage access
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Event Manager">
                      Event Manager — Create &amp; manage events
                    </SelectItem>
                ...
                <div className="mt-3 p-3 rounded-xl bg-[hsl(var(--muted))] text-xs text-[hsl(var(--muted-foreground))] space-y-1">
                  ...
                  <p>
                    ...
                    Can create, edit, and manage events and documents.
                  </p>
                  <p>
                    <span className="font-semibold text-[hsl(var(--foreground))]">
                      Viewer:
                    </span>{" "}
                    Can view events and analytics, no editing access.
                  </p>
                </div>
              </div>
              <DialogFooter>
                  ...
                  <td className="px-4 py-3 text-right">
                    {confirmRemove === member.id ? (
                      ...
                      <Button
                        ...
                        disabled={
                          member.role === "Admin" &&
                          team.filter((m) => m.role === "Admin").length <= 1
                        }
                      >
              ...
              <tr>
                <td colSpan={5} className="px-4 py-14 text-center">
                  ...
                  <p className="text-xs text-[hsl(var(--muted-foreground))] mb-3">
                    Invite colleagues to manage the platform together.
                  </p>
                  <Button
                    size="sm"
                    variant="outline"
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              {[
                {
                  perm: "View Events & Analytics",
                  admin: true,
                  manager: true,
                  viewer: true,
                },
                {
                  perm: "Create & Edit Events",
                  admin: true,
                  manager: true,
                  viewer: false,
                },
                ...
                {
                  perm: "Manage Participants",
                  admin: true,
                  manager: true,
                  viewer: false,
                },
                {
                  perm: "Publish / Go Live Events",
                  admin: true,
                  manager: true,
                  viewer: false,
                },
                {
                  perm: "Manage Organisers",
                  admin: true,
                  manager: false,
                  viewer: false,
                },
                ...
                <tr key={row.perm} className="attend-table-row">
                  ...
                  {[row.admin, row.manager, row.viewer].map((allowed, i) => (
                    <td key={i} className="px-4 py-3 text-center">
                      {allowed ? (
                        <span className="inline-flex items-center justify-center h-5 w-5 rounded-full bg-green-100 text-green-700 text-xs font-bold">
                          ✓
                        </span>
                      ) : (
                        <span className="inline-flex items-center justify-center h-5 w-5 rounded-full bg-[hsl(var(--muted))] text-[hsl(var(--muted-foreground))] text-xs">
                          —
                        </span>
                      )}
                    </td>
