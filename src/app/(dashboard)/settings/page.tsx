...
function IntegrationRow({ label, status, desc }: { label: string; status: "connected" | "disconnected" | "pending"; desc: string }) {
  const colors = {
    ...
    pending: { icon: Link2, color: "text-yellow-600", bg: "bg-yellow-50", text: "Pending" },
  };
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-[hsl(var(--muted-foreground))] mt-1">Manage platform configuration, compliance, and integrations</p>
      </div>
      ...
      <div className="flex flex-col gap-5">
        <Card className="attend-card p-6">
          ...
          <div className="border-t border-[hsl(var(--border))] pt-4">
            <div className="attend-section-title mb-3">Notification Preferences</div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between py-3 border-t border-[hsl(var(--border))]">
              <div>
                ...
                <div className="text-xs text-[hsl(var(--muted-foreground))]">Nigeria Data Protection Act — explicit consent collection enabled</div>
              </div>
        ...
        <Card className="attend-card p-6">
          ...
          <IntegrationRow label="NGX/CSCS Market Data" desc="Nigerian Exchange Group & CSCS shareholder data link" status="connected" />
          <IntegrationRow label="BVN/NIN Gateway (NIBSS)" desc="National Identity Management Commission verification" status="connected" />
          <IntegrationRow label="Payment Gateway (Paystack)" desc="Event registration payment processing" status="connected" />
          <IntegrationRow label="Streaming Provider (Mux)" desc="Live virtual event video streaming" status="pending" />
          <IntegrationRow label="SMS Gateway (Termii)" desc="OTP and notification delivery" status="disconnected" />
          <div className="flex justify-end mt-4">
