...
export default function AnalyticsPage() {
  const { events, participants, documents, liveVotes, organisers } = useStore();
  ...
  const topOrganisers = [...organisers]
    .sort((a, b) => b.eventsCount - a.eventsCount)
    .slice(0, 3);
  const maxEvents = topOrganisers[0]?.eventsCount ?? 1;
    ...
    <div>
      ...
      <Card className="attend-card p-5 mb-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <div className="attend-section-title">Top Organisers by Events</div>
        </div>
