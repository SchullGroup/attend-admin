    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-[hsl(var(--muted-foreground))] mt-1">
          Configure and publish a new event on the Attend platform
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        <Card className="attend-card p-6">
          ...
          <p className="text-sm text-[hsl(var(--muted-foreground))] mb-5">
            Select a module type and fill in the basic details
          </p>

          <div className="mb-5">
            <Label className="mb-3 block attend-section-title">
              Module Type
            </Label>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <Label htmlFor="organiser" className="mb-2 block">
                Organiser
              </Label>
              <Input
                id="organiser"
        ...
        <Card className="attend-card p-6">
          ...
          <p className="text-sm text-[hsl(var(--muted-foreground))] mb-5">
            Set the date, time, and delivery format for this event
          </p>
        ...
        <Card className="attend-card p-6">
          ...
          <p className="text-sm text-[hsl(var(--muted-foreground))] mb-5">
            Control attendance limits and registration windows
          </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <Label htmlFor="rsvpDeadline" className="mb-2 block">
                RSVP Deadline
              </Label>
              <Input
                id="rsvpDeadline"
